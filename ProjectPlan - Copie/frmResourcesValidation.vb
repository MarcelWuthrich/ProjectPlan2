...
Public Class frmResourcesValidation
    ...
    Private Sub frmResourcesValidation_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'DsVPlanResourceToday.vplanresourcetoday' table. You can move, or remove it, as needed.
        Me.VplanresourcetodayTableAdapter.Fill(Me.DsVPlanResourceToday.vplanresourcetoday)
        Exit Sub
    ...
    Private Sub lstPlanResources_SelectedIndexChanged(sender As Object, e As EventArgs)
        Try
            'On lit le membre de projet sélectionné
