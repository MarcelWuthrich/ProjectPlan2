...
Public Class frmResourcesTable
    ...
    Private Sub frmResourcesTable_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            myDateFrom = Today
            myDateTo = DateAdd(DateInterval.Day, 30, myDateFrom)
    ...
    Private Sub pCreateDGVColumns()
        ...
        Try
            ...
            'Tous les membres de projets existants sur la période données
            ...
            'Tous les membres de projets
            SQL = ""
            SQL &= "SELECT ID_ProjectMember, FirstName, LastName "
            SQL &= "FROM projectsmembers "
            SQL &= "WHERE Enable = 1 And IsDelete = 0 "
            SQL &= "ORDER BY ID_ProjectMember ASC; "
